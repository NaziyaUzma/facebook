	...
	function getFacebookInfo(){
		...
		localStorage.setItem("Token", myFacebookToken); //storing cookies for Token 
        	...
        	$.ajax({
                type:'GET',
                dataType:'json',
                url:'https://graph.facebook.com/me?fields=id,name,cover,education,work,birthday,gender,languages,quotes,email,address,picture.width(300).height(300),friends&access_token='+myFacebookToken,
                ...
                success : function(response){
                    ...
                    let frnds=[];
                    for(frnds of response.friends.data)
                    {
                        friends = frnds.name;
                        $("#myFriends").append(friends + ", "); 

                    }

                    $("#myFriends").append("+"+friendsCounts+" more"); 
